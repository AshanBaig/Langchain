# review le kr us pr hum dict bnae gye summry and seniment would be key of that dict
# api wla chl rha sahi 
...
#schema  
# literal me bta dia ke pos ya neg ana achaheye
# optional means agr wo chez na ho tw hata do like cons ya pros na ho tw hata do
class Reviews(TypedDict):
    key_theme: Annotated[list[str],"write down all key themes disscussed in the review in a list"]
    summary: Annotated[str,"A breif summary f the review "]      # summary word se he mere llm ko smjh a rha hy ky summary nikalni hy but agr ap summary ke liye alag se prompt dena cha rhy tw ye dedo
   
    # sentiments:Annotated[Literal["pos","neg"],"Return sentimnt of the review either negative postive or moderate"]
...
# conclusion:
"""
    - There is no GUrranty ke agr string bola tw string he haye llm dhoka de skhta hy  
    - isme validation nhi hogi like checking nhi hogi iske liye 2nd option hy 
    - Pydantic
